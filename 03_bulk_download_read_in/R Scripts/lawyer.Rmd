---
title: "Read-in script for Disambiguated lawyer data"
...
```{r}
setwd("")
data <- read.delim(unz("lawyer.tsv.zip", "lawyer.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
