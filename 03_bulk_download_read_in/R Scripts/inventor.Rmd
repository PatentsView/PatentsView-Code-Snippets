---
title: "Read-in script for Disambiguated inventor data"
...
```{r}
setwd("")
data <- read.delim(unz("inventor.tsv.zip", "inventor.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
