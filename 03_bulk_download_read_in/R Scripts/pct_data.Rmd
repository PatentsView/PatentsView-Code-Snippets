---
title: "Read-in script for PCT data"
...
```{r}
setwd("")
data <- read.delim(unz("pct_data.tsv.zip", "pct_data.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
