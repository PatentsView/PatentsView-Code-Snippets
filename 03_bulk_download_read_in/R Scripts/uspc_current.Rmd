---
title: "Read-in script for Current USPC classification data for all patents up to May 2015"
...
```{r}
setwd("")
data <- read.delim(unz("uspc_current.tsv.zip", "uspc_current.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
