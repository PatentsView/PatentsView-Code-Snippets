---
title: "Read-in script for Disambiguated location data, including latitude and longitude"
...
```{r}
setwd("")
data <- read.delim(unz("location.tsv.zip", "location.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
