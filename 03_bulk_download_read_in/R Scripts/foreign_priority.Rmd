---
title: "Read-in script for Foreign priority data"
...
```{r}
setwd("")
data <- read.delim(unz("foreign_priority.tsv.zip", "foreign_priority.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
