---
title: "Read-in script for International Patent Classification data for all patents (as of publication date)"
...
```{r}
setwd("")
data <- read.delim(unz("ipcr.tsv.zip", "ipcr.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
