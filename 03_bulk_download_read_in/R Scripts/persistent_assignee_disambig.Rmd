---
title: "Read-in script for Persistant Assignee Disambiguation"
...
```{r}
setwd("")
data <- read.delim(unz("persistent_assignee_disambig.tsv.zip", "persistent_assignee_disambig.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
