...
directory = ""
setwd(directory)
unzip("uspatentcitation.tsv.zip", exdir = directory)
```
...
n_obs = 0
repeat{
  data <- fread(paste(directory,"/uspatentcitation.tsv", sep = "", collapse = NULL), sep = '\t', quote = "\"", nrows =  chunk, skip = chunk*count,  header = TRUE)
