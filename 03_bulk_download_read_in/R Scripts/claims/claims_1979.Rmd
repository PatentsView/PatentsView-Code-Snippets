---
title: "Read-in script for 1979 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1979.tsv.zip", "claims_1979.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
