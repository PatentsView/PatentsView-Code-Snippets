---
title: "Read-in script for 1998 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1998.tsv.zip", "claims_1998.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
