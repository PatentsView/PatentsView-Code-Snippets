---
title: "Read-in script for 1978 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1978.tsv.zip", "claims_1978.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
