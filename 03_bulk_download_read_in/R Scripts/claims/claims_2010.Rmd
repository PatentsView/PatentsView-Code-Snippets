---
title: "Read-in script for 2010 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2010.tsv.zip", "claims_2010.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
