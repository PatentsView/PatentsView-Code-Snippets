---
title: "Read-in script for 2017 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2017.tsv.zip", "claims_2017.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
