---
title: "Read-in script for 1995 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1995.tsv.zip", "claims_1995.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
