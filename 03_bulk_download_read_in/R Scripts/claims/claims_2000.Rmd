---
title: "Read-in script for 2000 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2000.tsv.zip", "claims_2000.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
