---
title: "Read-in script for 2005 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2005.tsv.zip", "claims_2005.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
