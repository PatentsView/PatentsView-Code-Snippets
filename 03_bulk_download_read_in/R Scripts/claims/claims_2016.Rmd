---
title: "Read-in script for 2016 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2016.tsv.zip", "claims_2016.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
