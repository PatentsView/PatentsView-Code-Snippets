---
title: "Read-in script for 2004 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2004.tsv.zip", "claims_2004.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
