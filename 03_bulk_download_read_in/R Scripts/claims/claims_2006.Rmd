---
title: "Read-in script for 2006 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2006.tsv.zip", "claims_2006.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
