---
title: "Read-in script for 1999 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1999.tsv.zip", "claims_1999.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
