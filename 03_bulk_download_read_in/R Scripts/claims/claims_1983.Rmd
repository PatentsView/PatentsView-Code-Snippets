---
title: "Read-in script for 1983 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1983.tsv.zip", "claims_1983.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
