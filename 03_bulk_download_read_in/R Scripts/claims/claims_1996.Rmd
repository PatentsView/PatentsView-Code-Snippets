---
title: "Read-in script for 1996 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1996.tsv.zip", "claims_1996.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
