---
title: "Read-in script for 1980 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1980.tsv.zip", "claims_1980.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
