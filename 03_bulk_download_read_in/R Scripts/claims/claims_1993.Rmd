---
title: "Read-in script for 1993 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1993.tsv.zip", "claims_1993.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
