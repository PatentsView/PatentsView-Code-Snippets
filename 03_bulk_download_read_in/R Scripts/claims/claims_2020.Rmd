---
title: "Read-in script for 2020 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2020.tsv.zip", "claims_2020.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
