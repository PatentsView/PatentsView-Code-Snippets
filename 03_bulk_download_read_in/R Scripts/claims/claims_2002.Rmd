---
title: "Read-in script for 2002 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2002.tsv.zip", "claims_2002.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
