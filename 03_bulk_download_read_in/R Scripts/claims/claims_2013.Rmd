---
title: "Read-in script for 2013 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2013.tsv.zip", "claims_2013.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
