---
title: "Read-in script for 1984 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1984.tsv.zip", "claims_1984.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
