---
title: "Read-in script for 1988 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1988.tsv.zip", "claims_1988.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
