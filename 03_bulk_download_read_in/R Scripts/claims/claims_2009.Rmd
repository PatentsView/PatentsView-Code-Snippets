---
title: "Read-in script for 2009 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2009.tsv.zip", "claims_2009.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
