---
title: "Read-in script for 2015 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2015.tsv.zip", "claims_2015.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
