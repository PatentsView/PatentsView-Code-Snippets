---
title: "Read-in script for 1977 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1977.tsv.zip", "claims_1977.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
