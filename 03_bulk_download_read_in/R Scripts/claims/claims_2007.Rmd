---
title: "Read-in script for 2007 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2007.tsv.zip", "claims_2007.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
