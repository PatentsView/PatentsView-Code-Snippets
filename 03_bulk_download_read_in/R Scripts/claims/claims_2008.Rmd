---
title: "Read-in script for 2008 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2008.tsv.zip", "claims_2008.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
