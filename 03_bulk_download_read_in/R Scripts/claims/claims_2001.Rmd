---
title: "Read-in script for 2001 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2001.tsv.zip", "claims_2001.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
