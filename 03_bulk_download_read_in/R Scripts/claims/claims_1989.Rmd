---
title: "Read-in script for 1989 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1989.tsv.zip", "claims_1989.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
