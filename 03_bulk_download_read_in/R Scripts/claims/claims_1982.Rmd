---
title: "Read-in script for 1982 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1982.tsv.zip", "claims_1982.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
