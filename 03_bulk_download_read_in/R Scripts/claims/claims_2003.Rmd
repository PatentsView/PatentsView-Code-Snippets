---
title: "Read-in script for 2003 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2003.tsv.zip", "claims_2003.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
