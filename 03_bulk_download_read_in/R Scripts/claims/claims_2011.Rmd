---
title: "Read-in script for 2011 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2011.tsv.zip", "claims_2011.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
