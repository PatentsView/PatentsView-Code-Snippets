---
title: "Read-in script for 1986 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1986.tsv.zip", "claims_1986.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
