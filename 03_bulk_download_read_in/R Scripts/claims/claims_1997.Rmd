---
title: "Read-in script for 1997 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1997.tsv.zip", "claims_1997.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
