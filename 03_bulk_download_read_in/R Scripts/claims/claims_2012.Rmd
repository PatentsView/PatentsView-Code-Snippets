---
title: "Read-in script for 2012 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2012.tsv.zip", "claims_2012.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
