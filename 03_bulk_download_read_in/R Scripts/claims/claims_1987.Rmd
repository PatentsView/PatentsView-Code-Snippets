---
title: "Read-in script for 1987 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1987.tsv.zip", "claims_1987.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
