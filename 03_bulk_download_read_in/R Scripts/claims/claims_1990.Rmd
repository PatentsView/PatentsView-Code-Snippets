---
title: "Read-in script for 1990 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1990.tsv.zip", "claims_1990.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
