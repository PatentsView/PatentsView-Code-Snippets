---
title: "Read-in script for 1994 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1994.tsv.zip", "claims_1994.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
