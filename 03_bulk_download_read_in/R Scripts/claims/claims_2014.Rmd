---
title: "Read-in script for 2014 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2014.tsv.zip", "claims_2014.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
