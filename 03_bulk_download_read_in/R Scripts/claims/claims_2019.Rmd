---
title: "Read-in script for 2019 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_2019.tsv.zip", "claims_2019.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
