---
title: "Read-in script for 1991 Claims Data"
...
```{r}
setwd("")
data <- read.delim(unz("claims_1991.tsv.zip", "claims_1991.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
