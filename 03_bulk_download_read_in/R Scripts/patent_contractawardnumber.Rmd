...
```{r}
setwd("")
data <- read.delim(unz("patent_contractawardnumber.tsv.zip", "patent_contractawardnumber.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
