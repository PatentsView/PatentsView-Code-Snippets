---
title: "Read-in script for USPC classification data for all patents"
...
```{r}
setwd("")
data <- read.delim(unz("uspc.tsv.zip", "uspc.tsv"), header = TRUE, comment.char="#",  stringsAsFactors = FALSE, quote="\"", fill = FALSE, na.strings = "")
```
