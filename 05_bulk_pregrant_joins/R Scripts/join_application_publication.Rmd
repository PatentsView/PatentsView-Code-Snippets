...
# The application file is too large to unzip in R
app <- fread("application.tsv", sep="\t", na.strings=c("", " ", "na", "NA", "N/A", NA))

pub <- fread("publication.tsv", sep="\t", na.strings=c("", " ", "na", "NA", "N/A", NA))
```
