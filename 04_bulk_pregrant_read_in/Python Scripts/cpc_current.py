...
dt = {'id': 'str', 'document number': 'str', 'sequence': 'int', 'version': 'str', 'section_id': 'str', 'subsection_id': 'str', 'group_id': 'str', 'subgroup_id': 'str', 'symbol_position': 'str', 'value': 'str', 'category': 'str'}
