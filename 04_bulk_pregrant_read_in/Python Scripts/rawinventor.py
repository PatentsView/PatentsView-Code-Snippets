...
dt ={'id': 'str', 'document_number': 'str', 'inventor_id': 'str', 'name_first': 'str', 'name_last': 'str', 'sequence': 'int', 'designation': 'str', 'deceased': 'bool', 'rawlocation_id': 'str', 'city': 'str', 'state': 'str', 'country': 'str'}
