...
The merged_assignee_location table contains `r comma_format()(nrow(merged_assignee_location))` rows and the patent table contains `r comma_format()(nrow(patent))`. The complete_merge contains `r comma_format()(nrow(complete_merge))` rows. Thus, all of the patent_ids in the merged_assignee_location table have matches in the patent table.
